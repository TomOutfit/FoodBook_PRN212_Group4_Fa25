        ...
        private void InitializeTranslations()
        {
            ...
            var translations = new Dictionary<string, Dictionary<string, string>>
            {
                ["English"] = new Dictionary<string, string>
                {
                    ...
                    ["Auto-save recipes"] = "Auto-save recipes",
                    ...
                    ["AI Judge Status"] = "AI Judge Status",
                    ["Active"] = "Active",
                ...
                ["Vietnamese"] = new Dictionary<string, string>
                {
                    ...
                    ["Email"] = "Email",
                    ["Save"] = "Lưu",
                    ["Day Theme"] = "Giao Diện Ban Ngày",
                    ["Night Theme"] = "Giao Diện Ban Đêm",
                    ["Role"] = "Vai Trò",
                    ["Administrator"] = "Quản Trị Viên",
                    ["Auto-save recipes"] = "Tự động lưu công thức",
                    ["Refresh Profile"] = "Làm mới hồ sơ",
                    ...
                    ["AI Judge Status"] = "Trạng Thái AI Judge",
                    ["Active"] = "Hoạt Động",
