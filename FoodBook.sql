...
BEGIN
    CREATE TABLE [dbo].[Recipes](
        ...
        [UserId] [int] NOT NULL,
        [IsAIGenerated] [bit] NOT NULL DEFAULT(0), -- Flag to identify AI-generated recipes
        [CreatedAt] [datetime2](7) NOT NULL DEFAULT(GETUTCDATE()),
...
ELSE
BEGIN
    -- Add IsAIGenerated column if table exists but column doesn't
    IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[Recipes]') AND name = 'IsAIGenerated')
    BEGIN
